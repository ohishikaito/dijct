...
```sh
go get github.com/wakuwaku3/dijct
```
...
container.Invoke(func(
	...
	// service1 is auto resolved by container.
	// dijct.Container, dijct.IoCContainer,
	// dijct.ServiceLocator are auto resolved without register. These are equal to container.
})
container.Invoke(func(
	service1 Service1,
) {
